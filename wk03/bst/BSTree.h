...
int  BSTWidth(Tree);           // compute width of Tree
int  TreeHeight(Tree);         // compute height of Tree
int  nodeDepth(Tree, Item);    // find the depth of the node that contains Item
int  countInternal(Tree);      // count #internal nodes (has at least one child) in Tree
